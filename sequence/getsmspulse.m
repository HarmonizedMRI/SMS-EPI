...
%   nSlices      number of SMS slices (multi-band factor)
...
% frequency offset for shift equal to slThick (for returning to caller)
freq = sysGE.gamma*gPlateau*1e-4*slThick;   % Hz
...
tbw = 6;
dur = 8e-3;        % s
mb = 6;            % multiband factor (number of slices)
