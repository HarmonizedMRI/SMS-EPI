...
gro1 = struct('type', 'grad', ...
      'channel', 'x', ...
      'waveform', [0 gamp], ...
      'delay', 0, ...
      'tt', [0 blipDuration/2], ...
      'shape_dur', blipDuration/2, ...
      'area', gamp * blipDuration/2 / 2, ...
      'first', 0, ...
      'last', gamp);

t2 = gro.riseTime - blipDuration/2;
t3 = t2 + gro.flatTime;
t4 = t3 + gro.fallTime - blipDuration/2;
gro2 = struct('type', 'grad', ...
      'channel', 'x', ...
      'waveform', [gro1.last gro.amplitude gro.amplitude gro1.last], ...
      'delay', 0, ...
      'tt', [0 t2 t3 t4], ...
      'shape_dur', t4, ...
      'area', gro.area - 2*gro1.area, ...
      'first', gro1.last, ...
      'last', gro1.last);

gro3 = struct('type', 'grad', ...
      'channel', 'x', ...
      'waveform', [gamp 0], ...
      'delay', 0, ...
      'tt', [0 blipDuration/2], ...
...
gro31 = struct('type', 'grad', ...
      'channel', 'x', ...
      'waveform', [gamp -gamp], ...
      'delay', 0, ...
      'tt', [0 blipDuration], ...
      'shape_dur', blipDuration, ...
      'area', gamp * blipDuration/2, ...
      'first', gamp, ...
      'last', -gamp);
