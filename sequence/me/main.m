...
% 4. mb=1 2D fully-sampled, in-plane grappa reference scan
% 5. mb=1 2D SE blip up/down
% 6. EPI noise scan (no rf, except one at end to make seq2ge() happy)
% 7. 3D EPI mb=6
% 8. 3D EPI mb=1
% 9. 3D GRE B0 mapping
...
if TODO(2)
    writeEPI(voxelSize, [nx ny nz], TE, TR, alpha, mb, IY, IZ, nFrames, 'SMS', ...
        'nDummyFrames', nDummyFrames,...
        'seqName', 'cal', ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
        'gySign', gySign, ...
...
nFrames = 2; 
if TODO(3)
    writeEPI(voxelSize, [nx ny nz], TE, 4*TR, alpha, mb, IY, IZ, nFrames, 'SMS', ...
        'nDummyFrames',nDummyFrames,...
        'seqName', '2d', ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
...
%  in-plane GRAPPA reference 

mb = 1; Ry = 1; caipiShiftZ = 0;
[IY, IZ] = getcaipi(ny, nz, Ry, mb, caipiShiftZ, '3DEPI/caipi');
etl = 2*ceil(pf_ky*ny/Ry/2);   % echo train length. even
IY = IY(end-etl+1:end);
IZ = IZ(end-etl+1:end);
...
nFrames = 1; 
if TODO(4)
    writeEPI(voxelSize, [nx ny nz], TE, 2*4*TR, alpha, mb, IY, IZ, nFrames, 'SMS', ...
        'nDummyFrames',nDummyFrames,...
        'seqName', '2d_Ry1', ...
        'fatSat', fatSat, ...
        'RFspoil', RFspoil, ...
        ...
        'fatFreqSign', fatFreqSign, ...
        'doConj', doConj, ...
        'doRefScan', false, ...  % if true, 1st frame is ghost calibration (blips off)
        'simulateSliceProfile', true, ...
