function mask = getmask(d2d, kxo, nx, fov)
% function mask = getmask(d2d, kxo, nx, fov)
%
% Get object mask from combining +gx and -gx acquisitions.
%
...
for isl = 1:1:nslices
	...
	xsos = zeros(nx,nx);  % sum-of-squares coil combined image (for mask)
